...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, SENSE_OVERTRAVEL_Pin|DEBUG2_Pin|DEBUG1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SENSE_EBS_Pin SENSE_LEFT_Pin SENSE_RIGHT_Pin SENSE_DRIVER_Pin
                           SENSE_INERTIA_Pin */
  GPIO_InitStruct.Pin = SENSE_EBS_Pin|SENSE_LEFT_Pin|SENSE_RIGHT_Pin|SENSE_DRIVER_Pin
                          |SENSE_INERTIA_Pin;
